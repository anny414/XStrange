...
from XStrangeBot import (
    DEV_USERS,
    EVENT_LOGS, 
    BOT_USERNAME,
    ubot2,
)
from XStrangeBot import pbot as app 
from XStrangeBot import arq
from XStrangeBot.services.keyboard import Ikb
from XStrangeBot.utils.pluginhelper import convert_seconds_to_minutes as time_convert, fetch
from XStrangeBot.services.tasks import _get_tasks_text, all_tasks, rm_task
from XStrangeBot.services.types import InlineQueryResultCachedDocument
from XStrangeBot.modules.info import get_chat_info, get_user_info
from XStrangeBot.modules.music import download_youtube_audio
from XStrangeBot.utils.functions import test_speedtest
from XStrangeBot.utils.pastebin import paste
...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("Main bot", url="https://t.me/XStrangeBot"),
        InlineKeyboardButton(

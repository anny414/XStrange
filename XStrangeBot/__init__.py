...
def get_user_list(__init__, key):
    with open("{}/XStrangeBot/{}".format(os.getcwd(), __init__), "r") as json_file:
        return json.load(json_file)[key]


# enable logging
FORMAT = "[XStrangeBot] %(message)s"
logging.basicConfig(
...
LOGGER = logging.getLogger("[XStrangeBot]")
...
if ENV:
    ...
    from XStrangeBot.config import Development as Config
...
from XStrangeBot.modules.helper_funcs.handlers import (

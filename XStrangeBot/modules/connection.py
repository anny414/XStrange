...
import XStrangeBot.modules.sql.connection_sql as sql
from XStrangeBot import dispatcher, DRAGONS, DEV_USERS
from XStrangeBot.modules.helper_funcs import chat_status

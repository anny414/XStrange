...
import XStrangeBot.modules.sql.global_bans_sql as gban_sql
import XStrangeBot.modules.sql.users_sql as user_sql
from XStrangeBot import DEV_USERS, OWNER_ID, dispatcher

...
from XStrangeBot.modules import ALL_MODULES
from XStrangeBot.modules.helper_funcs.chat_status import is_user_admin
from XStrangeBot.modules.helper_funcs.misc import paginate_modules
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("XStrangeBot.modules." + module_name)
...
def xstrange_about_callback(update, context):
    ...
    elif query.data == "xstrange_notes":
        query.message.edit_text(
...
def main():
    ...
    about_callback_handler = CallbackQueryHandler(
        xstrange_about_callback, pattern=r"xstrange_", run_async=True
    )
